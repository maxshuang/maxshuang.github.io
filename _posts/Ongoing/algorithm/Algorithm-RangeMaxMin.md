...
int t, n, m;
int a[N];
// mx is the max element, se is the second max element
// cn is the count of max element
// tag is the lazy tag for situation: se<=v<mx
...
void pushtag(int u, int tg) {  
  ...
  mx[u] = tag[u] = tg;  // max element 变成了 tag
}
